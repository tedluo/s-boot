...
=======================================
	...
	06/29/2011	Ported to s-boot  for OpenBoard imx233 by
...
//rewrite 8bit io func for niuboot-sword case 
...
*/
static int dm9000_rx(struct eth_device *netdev, void (*NetReceive)(char *, int))	// added callback functions
{
	...
	for (;;) {
		...
		if ((RxStatus & 0xbf00) || (RxLen < 0x40)
			...
			NetReceive(NetRxPackets[0], RxLen);		  // 20110713
			break;	// 2011013
		}
	}
	return 0;
